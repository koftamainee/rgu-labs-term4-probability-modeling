...
ApplicationWindow {
    ...
    readonly property color card:    "#1a2235"
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            color: root.surface
            Rectangle { anchors.right: parent.right; width: 1; height: parent.height; color: root.border }
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: root.txt; lineHeight: 1.3
                    }
                    Rectangle { anchors.bottom: parent.bottom; width: 32; height: 3; color: root.accent; radius: 2 }
                }
                ...
                AppButton {
                    Layout.fillWidth: true
                    label: "Load Graph File"; icon: "📂"; accent: root.accent
                    onClicked: fileDialog.open()
                }
                Text {
                    id: fileLabel
                    text: "No file loaded"
                    color: root.muted; font.pixelSize: 11; wrapMode: Text.Wrap
                    Layout.fillWidth: true
                }
                ...
                RowLayout {
                    ...
                    ModeTab { Layout.fillWidth: true; label: "MANUAL"; highlight: !root.autoRunning; accent: root.accent; onClicked: root.autoRunning = false }
                    ModeTab { Layout.fillWidth: true; label: "AUTO";   highlight: root.autoRunning;  accent: root.warn;   onClicked: if (root.simLoaded) root.autoRunning = true }
                }

                AppButton {
                    Layout.fillWidth: true; label: "Step  →"; accent: root.accent
                ...
                AppButton {
                    Layout.fillWidth: true; label: "Reset"; accent: root.muted
                ...
                Text { text: "SIR model"; color: root.muted; font.pixelSize: 10; font.letterSpacing: 1 }
            }
        }
        ...
        ColumnLayout {
            ...
            //  Stats bar
            Rectangle {
                Layout.fillWidth: true; height: 80; color: root.card
                Rectangle { anchors.bottom: parent.bottom; width: parent.width; height: 1; color: root.border }

                RowLayout {
                    anchors.fill: parent
                    anchors.leftMargin: 24; anchors.rightMargin: 24; spacing: 0

                    StatBadge { Layout.fillWidth: true; label: "HEALTHY";   value: sim_controller.healthy_count;   accent: root.success; fraction: root.totalCount }
                    StatDivider { Layout.fillHeight: true; Layout.topMargin: 12; Layout.bottomMargin: 12 }
                    StatBadge { Layout.fillWidth: true; label: "INFECTED";  value: sim_controller.infected_count;  accent: root.danger;  fraction: root.totalCount }
                    StatDivider { Layout.fillHeight: true; Layout.topMargin: 12; Layout.bottomMargin: 12 }
                    StatBadge { Layout.fillWidth: true; label: "RECOVERED"; value: sim_controller.recovered_count; accent: root.accent;  fraction: root.totalCount }
                    StatDivider { Layout.fillHeight: true; Layout.topMargin: 12; Layout.bottomMargin: 12 }
                    StatBadge { Layout.fillWidth: true; label: "TOTAL";     value: root.totalCount;                accent: root.muted;   fraction: 0 }

                    Item { Layout.fillWidth: true }

                    Column {
                        spacing: 6
                        Text { text: "SPREAD"; color: root.muted; font.pixelSize: 10; font.letterSpacing: 2 }
                        Rectangle {
                            width: 180; height: 8; radius: 4; color: root.border
                            Rectangle {
                                ...
                                gradient: Gradient {
                                    ...
                                    GradientStop { position: 0.0; color: root.warn }
            ...
            // Tab bar
            Rectangle {
                Layout.fillWidth: true; height: 44; color: root.surface
                Rectangle { anchors.bottom: parent.bottom; width: parent.width; height: 1; color: root.border }
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            Rectangle {
                                ...
                                color: root.activeTab === index ? root.accent : "transparent"
                            ...
                            Text {
                                ...
                                text: modelData
                                color: root.activeTab === index ? root.txt : root.muted
                                font.pixelSize: 13
                    ...
                    Text {
                        text: root.simLoaded
                            ...
                            : "○ NOT LOADED"
                        color: root.simLoaded ? (root.autoRunning ? root.warn : root.accent) : root.muted
            ...
            StackLayout {
                ...
                ColumnLayout {
                    ...
                    // Search toolbar
                    Rectangle {
                        Layout.fillWidth: true; height: 52; color: root.surface
                        Rectangle { anchors.bottom: parent.bottom; width: parent.width; height: 1; color: root.border }

                        RowLayout {
                            anchors.fill: parent
                            anchors.leftMargin: 16; anchors.rightMargin: 16; spacing: 8
                            Text { text: "SEARCH:"; color: root.muted; font.pixelSize: 11; font.letterSpacing: 2 }
                            SearchButton { label: "All Healthy";          mode: 1; currentMode: root.searchMode; accent: root.success; onClicked: { root.searchMode = 1; sim_controller.search_healthy() } }
                            SearchButton { label: "All Recovered";        mode: 2; currentMode: root.searchMode; accent: root.accent;  onClicked: { root.searchMode = 2; sim_controller.search_recovered() } }
                            SearchButton { label: "Recovered (lonely)";   mode: 3; currentMode: root.searchMode; accent: root.warn;    onClicked: { root.searchMode = 3; sim_controller.search_recovered_lonely() } }
                            SearchButton { label: "Healthy (surrounded)"; mode: 4; currentMode: root.searchMode; accent: root.danger;  onClicked: { root.searchMode = 4; sim_controller.search_healthy_surrounded() } }
                            SearchButton { label: "Clear";                mode: 0; currentMode: root.searchMode; accent: root.muted;   onClicked: { root.searchMode = 0; sim_controller.clear_search() } }
                            Item { Layout.fillWidth: true }
                        }
                    }
                    ...
                    // Results area
                    Rectangle {
                        Layout.fillWidth: true; Layout.fillHeight: true; color: root.bg
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                color: root.muted; font.pixelSize: 14
                            }
                            Text {
                                anchors.horizontalCenter: parent.horizontalCenter
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    color: root.txt; font.pixelSize: 16; font.bold: true
                                }
                                Item { Layout.fillWidth: true }
                                Text { text: searchResultModel.count + " results"; color: root.muted; font.pixelSize: 12 }
                            }
                            ...
                            GridView {
                                ...
                                delegate: Rectangle {
                                    width: 84; height: 50; radius: 6; color: root.card; border.width: 1
                                    border.color: { switch(root.searchMode) {
                                        case 1: return root.success; case 2: return root.accent
                                        case 3: return root.warn;    case 4: return root.danger
                                        default: return root.border
                                    }}
                                    Text { anchors.centerIn: parent; text: "ID " + model.nodeId; color: root.txt; font.pixelSize: 12; font.bold: true }
                                }
                            }
                        }
                    }
                ...
                GraphView {
                    ...
                    colHealthy:   root.success
                    colInfected:  root.danger
                    colRecovered: root.accent
                    colBg:        root.bg
                    colEdge:      root.border
                    colMuted:     root.muted
                    colTxt:       root.txt
                    colCard:      root.card
                    colBorder:    root.border
                    colAccent:    root.accent
                    colWarn:      root.warn
                }
            }
        }
