...
Item {
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: parent; onClicked: dlg.visible = false
        }
    }
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                // cover bottom radius
                Rectangle {
                    anchors.bottom: parent.bottom; width: parent.width; height: 10; color: Theme.card
                }
                Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        text: "Select tree config file (.txt)"
                    ...
                    Rectangle {
                        ...
                        Text {
                            anchors.centerIn: parent; text: "✕"; color: Theme.muted; font.pixelSize: 13
                        }
                        MouseArea {
                            id:
                                closeMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: dlg.visible = false
                        }
                    }
                }
            }
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        Text {
                            anchors.centerIn: parent; text: "↑"; color: Theme.accent; font.pixelSize: 14; font.bold: true
                        }
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                var parts = cur.split("/").filter(function (p) {
                                    return p !== ""
                                })
                                if (parts.length > 0) {
                                    parts.pop()
            ...
            Rectangle {
                ...
                radius: 10
                Rectangle {
                    anchors.top: parent.top; width: parent.width; height: 10; color: Theme.card
                }
                Rectangle {
                    anchors.top: parent.top; width: parent.width; height: 1; color: Theme.border
                }
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: Theme.border; border.width: 1
                        Text {
                            anchors.centerIn: parent; text: "Cancel"; color: Theme.muted; font.pixelSize: 13
                        }
                        MouseArea {
                            id:
                                cancelBtnMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: dlg.visible = false
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        Text {
                            anchors.centerIn: parent; text: "Open"; color: Theme.txt; font.pixelSize: 13; font.bold: true
                        }
                        MouseArea {
